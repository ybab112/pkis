...
namespace MyWebApp.Migrations
{
    ...
    [Migration("20260609072649_ReplaceSizeWithShoeSizes")]
    partial class ReplaceSizeWithShoeSizes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWebApp.Models.Shoe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyWebApp.Models.ShoeSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyWebApp.Models.OrderItem", b =>
                {
                    b.HasOne("MyWebApp.Models.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWebApp.Models.Shoe", "Shoe")
                        .WithMany()
